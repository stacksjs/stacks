...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('initial_balance', 'double', col => col.notNull())
    .addColumn('current_balance', 'double', col => col.notNull())
    ...
    .addColumn('expiry_date', 'double')
    .addColumn('last_used_date', 'double')
