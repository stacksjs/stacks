...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('total_price', 'text', col => col.notNull())
    .addColumn('tax_rate', 'text')
    .addColumn('tax_amount', 'text')
    .addColumn('discount_percentage', 'text')
    .addColumn('discount_amount', 'text')
