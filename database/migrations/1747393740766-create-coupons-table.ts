...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('discount_value', 'double', col => col.notNull())
    .addColumn('min_order_amount', 'double')
    .addColumn('max_discount_amount', 'double')
    .addColumn('free_product_id', 'varchar(255)')
    .addColumn('is_active', 'boolean')
    .addColumn('usage_limit', 'double')
    .addColumn('usage_count', 'double')
