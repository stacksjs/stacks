...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('download_limit', 'integer', col => col.notNull())
    .addColumn('expiry_days', 'integer', col => col.notNull())
    .addColumn('requires_login', 'boolean', col => col.notNull().defaultTo(false))
    .addColumn('automatic_delivery', 'boolean', col => col.notNull().defaultTo(false))
