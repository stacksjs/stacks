...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('is_verified_purchase', 'boolean', col => col.notNull())
    .addColumn('is_approved', 'boolean', col => col.notNull())
    .addColumn('is_featured', 'boolean', col => col.notNull())
    .addColumn('helpful_votes', 'integer', col => col.notNull().defaultTo(0))
    .addColumn('unhelpful_votes', 'integer', col => col.notNull().defaultTo(0))
