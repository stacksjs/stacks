...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('initial_balance', 'text', col => col.notNull())
    .addColumn('current_balance', 'text', col => col.notNull())
    ...
    .addColumn('is_digital', 'text')
    .addColumn('is_reloadable', 'text')
    .addColumn('is_active', 'text', col => col.defaultTo(true))
