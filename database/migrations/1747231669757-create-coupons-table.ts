...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('discount_value', 'text', col => col.notNull())
    .addColumn('min_order_amount', 'text')
    .addColumn('max_discount_amount', 'text')
    .addColumn('free_product_id', 'text')
    .addColumn('is_active', 'text')
    .addColumn('usage_limit', 'text')
    .addColumn('usage_count', 'text')
