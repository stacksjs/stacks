...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('is_verified_purchase', 'text')
    .addColumn('is_approved', 'text')
    .addColumn('is_featured', 'text')
    .addColumn('helpful_votes', 'text', col => col.defaultTo(0))
    .addColumn('unhelpful_votes', 'text', col => col.defaultTo(0))
