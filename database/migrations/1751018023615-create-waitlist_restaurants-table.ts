...
export async function up(db: Database<any>) {
  await db.schema
    ...
    .addColumn('actual_wait_time', 'integer', col => col.notNull())
    .addColumn('queue_position', 'integer', col => col.notNull())
    .addColumn('seated_at', 'timestamp', col => col.notNull())
    .addColumn('no_show_at', 'timestamp', col => col.notNull())
    .addColumn('cancelled_at', 'timestamp', col => col.notNull())
