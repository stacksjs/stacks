...
Stacks uses Pantry to provision its Bun 1.4.2 workspace runtime and the rest of its toolchain. Install Pantry, run `pantry bootstrap` once, then create a project with Buddy and verify it before starting development.
