          ...
          items: [
            ...
            { text: 'Custom Directives', link: '/guide/custom-directives' },
            {
              ...
              items: [
                ...
                { text: 'DatePicker', link: '/guide/components/date-picker' },
                { text: 'Image', link: '/guide/components/image' },
                { text: 'InlineNav', link: '/guide/components/inline-nav' }, // breadcrumbs
                ...
                { text: 'Stack', link: '/guide/components/stack' }, // card
