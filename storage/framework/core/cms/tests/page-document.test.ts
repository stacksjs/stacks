...
// MySQL was left out until stacksjs/stacks#2637: createPageDocument and
// updatePageDocument both use returningAll(), which bun-query-builder before
// 0.2.70 rendered as `RETURNING *` on MySQL, so a page could not be created
// there at all.
