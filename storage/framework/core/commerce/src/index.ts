...
import * as digital from './shippings/digital'
import * as drivers from './shippings/drivers'
import * as giftCards from './gift-cards'
import * as licenses from './shippings/licenses'
...
import * as deliveryRoutes from './shippings/routes'
import * as shipping from './shippings/shipping'
