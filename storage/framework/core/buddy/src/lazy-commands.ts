...
const commandRegistry: Record<string, CommandLoader> = {
  ...
  'desktop:apple:init': { path: './commands/desktop-apple.ts', exportName: 'desktopApple' },
  ...
  'comments:list': { path: './commands/comments.ts', exportName: 'commentsCommands' },
  'comments:approve': { path: './commands/comments.ts', exportName: 'commentsCommands' },
  'comments:reject': { path: './commands/comments.ts', exportName: 'commentsCommands' },
  'comments:delete': { path: './commands/comments.ts', exportName: 'commentsCommands' },
  'user:add': { path: './commands/user.ts', exportName: 'user' },
  'user:list': { path: './commands/user.ts', exportName: 'user' },
  'unlink:core': { path: './commands/link.ts', exportName: 'link' },
  ...
  'core:status': { path: './commands/publish.ts', exportName: 'publish' },
