...
const SERVER_SCRIPT_ALLOWLIST: ReadonlySet<string> = new Set([
  ...
  'commerce/delivery/delivery-routes.stx',
  'commerce/delivery/digital-delivery.stx',
  'commerce/delivery/drivers.stx',
  'commerce/delivery/license-keys.stx',
  'commerce/delivery/shipping-methods.stx',
  'commerce/delivery/shipping-rates.stx',
  'commerce/delivery/shipping-zones.stx',
  'commerce/gift-cards/index.stx',
  'commerce/orders/index.stx',
  'commerce/payments/index.stx',
  'commerce/printers/devices/index.stx',
  'commerce/printers/receipts/index.stx',
  'commerce/taxes/index.stx',
  ...
  'insights/index.stx',
  'login.stx',
  'marketing/campaigns/index.stx',
  'marketing/lists/index.stx',
  'marketing/reviews/index.stx',
  'marketing/social-posts/index.stx',
  'models/[model].stx',
  'models/index.stx',
  'packages/index.stx',
  'register.stx',
