...
export const TITLE_TERMINATORS: Set<string> = new Set([
...
export const SMALL_WORDS: Set<string> = new Set([
  'a',
  'an',
  'and',
  'as',
...
export function titleCase(input: string, options: TitleCaseOptions | string[] | string = {}): string {
  const {
    locale = undefined,
    sentenceCase = false,
