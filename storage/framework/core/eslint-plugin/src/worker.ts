...
export async function getGenerator(configPath?: string): Promise<UnoGenerator<any>> {
...
export function setGenerator(generator: Awaited<UnoGenerator<any>>, configPath?: string | undefined): void {
