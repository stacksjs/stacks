...
export function initiateImports(): void {
  ...
  const options: AutoImportsOptions = {
    ...
    imports: [...defineModelImports, ...jobImports],
 ...
 *
 * This makes all models available globally, so users can write
 * `Post.where('title', 'test')` without imports.
 */
