...
export const capabilityRegistry: readonly CapabilityDriver[] = [
  ...
  { category: 'queue', name: 'redis', status: 'partial', implementation: 'storage/framework/core/queue/src/drivers/redis.ts', testEvidence: ['storage/framework/core/queue/tests/integration.test.ts', 'storage/framework/core/queue/tests/envelope.test.ts'], topology: 'worker-and-redis', prerequisites: ['Redis service'], limitations: ['Implementation and unit evidence exist, but CI does not retain a live Redis service contract.'] },
  ...
  { category: 'cache', name: 'redis', status: 'partial', implementation: 'storage/framework/core/cache/src/drivers/index.ts', testEvidence: ['storage/framework/core/cache/tests/integration.test.ts'], topology: 'client-server', prerequisites: ['Redis service'], limitations: ['Implementation and unit evidence exist, but CI does not retain a live Redis service contract.'] },
