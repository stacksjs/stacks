...
export const alias: Record<string, string> = {
  ...
  '@stacksjs/auctions': p.corePath('auctions/src/index.ts'),
  'stacks/auctions': p.corePath('auctions/src/index.ts'),
  '@stacksjs/auctions/*': p.corePath('auctions/src/*'),
  'stacks/auctions/*': p.corePath('auctions/src/*'),
