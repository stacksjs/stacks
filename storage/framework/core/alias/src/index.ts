...
export const alias: Record<string, string> = {
  ...
  // These resolve through corePath rather than a dedicated helper: they had
  // no alias entry at all, so source resolution for them depended entirely on
  // the `development` export condition.
  '@stacksjs/browser': p.corePath('browser/src/index.ts'),
  'stacks/browser': p.corePath('browser/src/index.ts'),
  '@stacksjs/browser/*': p.corePath('browser/src/*'),
  'stacks/browser/*': p.corePath('browser/src/*'),
  '@stacksjs/browser-extension': p.corePath('browser-extension/src/index.ts'),
  'stacks/browser-extension': p.corePath('browser-extension/src/index.ts'),
  '@stacksjs/browser-extension/*': p.corePath('browser-extension/src/*'),
  'stacks/browser-extension/*': p.corePath('browser-extension/src/*'),
  '@stacksjs/buddy': p.corePath('buddy/src/index.ts'),
  'stacks/buddy': p.corePath('buddy/src/index.ts'),
  '@stacksjs/buddy/*': p.corePath('buddy/src/*'),
  'stacks/buddy/*': p.corePath('buddy/src/*'),
  '@stacksjs/calendar-api': p.corePath('calendar-api/src/index.ts'),
  'stacks/calendar-api': p.corePath('calendar-api/src/index.ts'),
  '@stacksjs/calendar-api/*': p.corePath('calendar-api/src/*'),
  'stacks/calendar-api/*': p.corePath('calendar-api/src/*'),
  '@stacksjs/cms': p.corePath('cms/src/index.ts'),
  'stacks/cms': p.corePath('cms/src/index.ts'),
  '@stacksjs/cms/*': p.corePath('cms/src/*'),
  'stacks/cms/*': p.corePath('cms/src/*'),
  '@stacksjs/commerce': p.corePath('commerce/src/index.ts'),
  'stacks/commerce': p.corePath('commerce/src/index.ts'),
  '@stacksjs/commerce/*': p.corePath('commerce/src/*'),
  'stacks/commerce/*': p.corePath('commerce/src/*'),
  '@stacksjs/composables': p.corePath('composables/src/index.ts'),
  'stacks/composables': p.corePath('composables/src/index.ts'),
  '@stacksjs/composables/*': p.corePath('composables/src/*'),
  'stacks/composables/*': p.corePath('composables/src/*'),
  '@stacksjs/cron': p.corePath('cron/src/index.ts'),
  'stacks/cron': p.corePath('cron/src/index.ts'),
  '@stacksjs/cron/*': p.corePath('cron/src/*'),
  'stacks/cron/*': p.corePath('cron/src/*'),
  '@stacksjs/github': p.corePath('github/src/index.ts'),
  'stacks/github': p.corePath('github/src/index.ts'),
  '@stacksjs/github/*': p.corePath('github/src/*'),
  'stacks/github/*': p.corePath('github/src/*'),
  '@stacksjs/health': p.corePath('health/src/index.ts'),
  'stacks/health': p.corePath('health/src/index.ts'),
  '@stacksjs/health/*': p.corePath('health/src/*'),
  'stacks/health/*': p.corePath('health/src/*'),
  '@stacksjs/http': p.corePath('http/src/index.ts'),
  'stacks/http': p.corePath('http/src/index.ts'),
  '@stacksjs/http/*': p.corePath('http/src/*'),
  'stacks/http/*': p.corePath('http/src/*'),
  '@stacksjs/i18n': p.corePath('i18n/src/index.ts'),
  'stacks/i18n': p.corePath('i18n/src/index.ts'),
  '@stacksjs/i18n/*': p.corePath('i18n/src/*'),
  'stacks/i18n/*': p.corePath('i18n/src/*'),
  '@stacksjs/payments': p.corePath('payments/src/index.ts'),
  'stacks/payments': p.corePath('payments/src/index.ts'),
  '@stacksjs/payments/*': p.corePath('payments/src/*'),
  'stacks/payments/*': p.corePath('payments/src/*'),
  '@stacksjs/realtime': p.corePath('realtime/src/index.ts'),
  'stacks/realtime': p.corePath('realtime/src/index.ts'),
  '@stacksjs/realtime/*': p.corePath('realtime/src/*'),
  'stacks/realtime/*': p.corePath('realtime/src/*'),
  '@stacksjs/registry': p.corePath('registry/src/index.ts'),
  'stacks/registry': p.corePath('registry/src/index.ts'),
  '@stacksjs/registry/*': p.corePath('registry/src/*'),
  'stacks/registry/*': p.corePath('registry/src/*'),
  '@stacksjs/testing': p.corePath('testing/src/index.ts'),
  'stacks/testing': p.corePath('testing/src/index.ts'),
  '@stacksjs/testing/*': p.corePath('testing/src/*'),
  'stacks/testing/*': p.corePath('testing/src/*'),
  '@stacksjs/tunnel': p.corePath('tunnel/src/index.ts'),
  'stacks/tunnel': p.corePath('tunnel/src/index.ts'),
  '@stacksjs/tunnel/*': p.corePath('tunnel/src/*'),
  'stacks/tunnel/*': p.corePath('tunnel/src/*'),
  '@stacksjs/whois': p.corePath('whois/src/index.ts'),
  'stacks/whois': p.corePath('whois/src/index.ts'),
  '@stacksjs/whois/*': p.corePath('whois/src/*'),
  'stacks/whois/*': p.corePath('whois/src/*'),
  ...
  '@stacksjs/audio': p.frameworkPath('core/audio/src/index.ts'),
  'stacks/audio': p.frameworkPath('core/audio/src/index.ts'),
  ...
  '@stacksjs/charts': p.chartsPath('src/index.ts'),
  'stacks/charts': p.chartsPath('src/index.ts'),
  '@stacksjs/charts/*': p.chartsPath('src/*'),
  'stacks/charts/*': p.chartsPath('src/*'),
  ...
  '@stacksjs/feature-flags': p.featureFlagsPath('src/index.ts'),
  'stacks/feature-flags': p.featureFlagsPath('src/index.ts'),
  '@stacksjs/feature-flags/*': p.featureFlagsPath('src/*'),
  'stacks/feature-flags/*': p.featureFlagsPath('src/*'),
  ...
  '@stacksjs/forms': p.corePath('forms/src/index.ts'),
  'stacks/forms': p.corePath('forms/src/index.ts'),
  '@stacksjs/forms/*': p.corePath('forms/src/*'),
  'stacks/forms/*': p.corePath('forms/src/*'),
  ...
  '@stacksjs/image': p.frameworkPath('core/image/src/index.ts'),
  'stacks/image': p.frameworkPath('core/image/src/index.ts'),
  ...
  '@stacksjs/newsletter': p.newsletterPath('src/index.ts'),
  'stacks/newsletter': p.newsletterPath('src/index.ts'),
  '@stacksjs/newsletter/*': p.newsletterPath('src/*'),
  'stacks/newsletter/*': p.newsletterPath('src/*'),
  ...
  '@stacksjs/sites': p.corePath('sites/src/index.ts'),
  'stacks/sites': p.corePath('sites/src/index.ts'),
  '@stacksjs/sites/*': p.corePath('sites/src/*'),
  'stacks/sites/*': p.corePath('sites/src/*'),
  '@stacksjs/skills': p.skillsPath('src/index.ts'),
  ...
  'stacks/features': p.featuresPath('src/index.ts'),
  '@stacksjs/pagination': p.paginationPath('src/index.ts'),
  'stacks/pagination': p.paginationPath('src/index.ts'),
  '@stacksjs/model-meta': p.modelMetaPath('src/index.ts'),
  'stacks/model-meta': p.modelMetaPath('src/index.ts'),
  '@stacksjs/action-runner': p.actionRunnerPath('src/index.ts'),
  'stacks/action-runner': p.actionRunnerPath('src/index.ts'),
  ...
  '@stacksjs/video': p.frameworkPath('core/video/src/index.ts'),
  'stacks/video': p.frameworkPath('core/video/src/index.ts'),
