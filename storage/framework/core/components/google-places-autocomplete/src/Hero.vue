...
<template>
  <div class="flex flex-col items-center gap-3">
    ...
    <p class="mb-3 mt-0 text-lg">
      A modern address input component with Google Maps API integration.
    </p>
    ...
    <div class="flex gap-2 mt-4">
      <a
        ...
        href="https://github.com/stacksjs/stacks/tree/main/storage/framework/core/components/google-places-autocomplete"
        target="_blank"
      >
        GitHub
      </a>
