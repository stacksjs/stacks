...
<template>
  <div class="flex flex-col items-center gap-3">
    ...
    <p class="mb-3 mt-0 text-lg">
      An opinionated switch component for Stacks.
    </p>
    <div class="flex gap-2">
      <div class="relative z-20 mr-4 inline-block flex flex-col text-left">
        <Switch
          v-model="enabled"
          :class="enabled ? 'bg-blue-500' : 'bg-gray-400'"
          class="relative h-[38px] w-[74px] inline-flex shrink-0 cursor-pointer border-2 border-transparent rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75"
        >
      ...
      <a
        ...
        href="https://github.com/stacksjs/stacks/tree/main/storage/framework/core/components/switch"
        target="_blank"
      >
        GitHub
      </a>
