...
<template>
  <div class="flex flex-col items-center gap-3">
    ...
    <p class="mb-3 mt-0 text-lg">
      An opinionated navigator component.
    </p>
    <div class="flex gap-2">
      <button
        ...
        @click="
          () => {
            notification('stacks/navigator', {
              description: 'An opinionated navigator component for Stacks.',
            })
          }
        "
      >
      ...
      <a
        ...
        href="https://github.com/stacksjs/stacks/tree/main/storage/framework/core/components/navigator"
        target="_blank"
      >
        GitHub
      </a>
