...
//     p.then((promiseData: any) => {
//       if (promiseData && typeof promiseData.ok === 'boolean' && !promiseData.ok) {
//         shouldDismiss = false
...
//         const description = typeof data.description === 'function' ? data.description(promiseData) : data.description
