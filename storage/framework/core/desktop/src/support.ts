...
export const desktopSupportMatrix: readonly DesktopSupportRow[] = [
  { platform: 'darwin', architecture: 'arm64', status: 'experimental', osVersions: ['macOS 15 runner'], packageFormat: 'DMG + PKG', signing: 'pending', notarization: 'pending', installLaunchEvidence: 'https://github.com/stacksjs/stacks/actions/workflows/desktop-lifecycle.yml', updateRollbackEvidence: 'https://github.com/stacksjs/stacks/actions/workflows/desktop-lifecycle.yml', packagingEvidence: 'https://github.com/stacksjs/stacks/blob/main/protocol/evidence/craft.json', blockingIssues: ['https://github.com/stacksjs/stacks/issues/2062', 'https://github.com/home-lang/craft/issues/11'], limitations: ['Lifecycle fixtures are unsigned while platform identities remain unprovisioned.', 'Craft v0.0.47 is source-tagged, but its upstream release workflow is blocked by repository Actions policy.'] },
