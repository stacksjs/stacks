 ...
 */
export const GENERATED_MIGRATION_MARKER = '-- @generated by `buddy migrate:regenerate` — edits will be overwritten'
...
export function isGeneratedMigration(dir: string, file: string): boolean {
  try {
    // The marker is on the first line; no need to read a large file.
