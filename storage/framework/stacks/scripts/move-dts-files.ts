...
const files = await glob([
  '../dist/types/storage/framework/stacks/src/**/src/*.d.ts',
  '../dist/types/storage/framework/stacks/src/**/src/*.d.ts.map',
  '../dist/types/storage/framework/stacks/src/**/src/**/*.d.ts',
  '../dist/types/storage/framework/stacks/src/**/src/**/*.d.ts.map',
  '../dist/types/storage/framework/stacks/src/**/src/**/**/*.d.ts',
  '../dist/types/storage/framework/stacks/src/**/src/**/**/*.d.ts.map',
...
for (const file of files) {
  const path = file
    .replace('../dist/types/storage/framework/stacks/src/', '../core/')
    .replace('/src/', '/dist/')
