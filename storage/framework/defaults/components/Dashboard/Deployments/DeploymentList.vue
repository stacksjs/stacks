              ...
              <div class="mt-6">
                <dl class="grid grid-cols-1 sm:grid-cols-2">
                  <div class="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
                    <dt class="text-sm text-gray-900 font-medium leading-6">
                      Deployment URL
                    </dt>
                    <dd class="mt-1 text-sm text-gray-700 leading-6 sm:mt-2">
                      https://my-app.org
                    </dd>
                  </div>
                  <div class="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
                    ...
                    <dd class="mt-1 text-sm text-gray-700 leading-6 font-mono sm:mt-2">
                      main
                    </dd>
                  </div>
