...
<template>
  <div class="min-h-screen py-4 dark:bg-blue-gray-800 lg:py-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      Demo notification that runs every minute
                    </td>

                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 font-mono">
                      ./app/Notifications/WelcomeEmail.ts
                    </td>
    ...
    <div class="px-4 pt-20 lg:px-8 sm:px-6">
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          <h1 class="text-base text-gray-900 font-semibold leading-6">
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                      <a href="#" class="text-blue-600 hover:text-blue-900">View<span class="sr-only">, Notification</span></a>
                    </td>
                  </tr>
                </tbody>
              </table>
