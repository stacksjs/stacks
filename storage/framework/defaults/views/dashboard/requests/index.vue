          ...
          <div class="relative overflow-hidden rounded-lg bg-white px-4 pt-5 shadow sm:px-6 sm:pt-6">
            <dt>
              <div class="absolute rounded-md bg-blue-500 p-3">
                <div class="i-hugeicons-globe-americas h-6 w-6 text-white" />
              </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <span class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs text-green-700 font-medium ring-1 ring-green-600/20 ring-inset">
                        Success
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <span class="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs text-red-700 font-medium ring-1 ring-red-600/20 ring-inset">
                        Error
                      </span>
                    </td>
