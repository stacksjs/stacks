import type { ColumnType, Generated, Insertable, Selectable, Updateable } from 'kysely'
    ...
    export class SubscriberModel {
      ...
      // Method to find a subscriber by email
      static async findByEmail(email: string): Promise<SubscriberModel | null> {
      ...
      async where(criteria: Partial<SubscriberType>, options: QueryOptions = {}) {
        let query = db.selectFrom('subscribers')
