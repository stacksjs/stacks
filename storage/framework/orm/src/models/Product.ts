...
export class ProductModel {
  ...
  whereRef(column: string, ...args: string[]): ProductModel {
    return ProductModel.whereRef(column, ...args)
  }
  ...
  orWhere(...conditions: (string | [string, any] | [string, string, any])[]): ProductModel {
    return ProductModel.orWhere(...conditions)
  }

  static orWhere(...conditions: (string | [string, any] | [string, string, any])[]): ProductModel {
    const instance = new ProductModel(null)
