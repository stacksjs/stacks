...
export class PageModel extends BaseOrm<PageModel, PagesTable, PageJsonResponse> {
  ...
  constructor(page: PageJsonResponse | undefined) {
    ...
    this.withRelations = []
    this.selectFromQuery = db.selectFrom('pages')
    this.updateFromQuery = db.updateTable('pages')
    this.deleteFromQuery = db.deleteFrom('pages')
...
set updated_at(value: string) {
  ...
  static async find(id: number): Promise<PageModel | undefined> {
    let query = db.selectFrom('pages').where('id', '=', id).selectAll()
  ...
  static async all(): Promise<PageModel[]> {
    ...
    const models = await db.selectFrom('pages').selectAll().execute()
  ...
  async applyCreate(newPage: NewPage): Promise<PageModel> {
    ...
    const result = await db.insertInto('pages')
      .values(filteredValues)
      .executeTakeFirst()

    const model = await db.selectFrom('pages')
  ...
  async delete(): Promise<number> {
    ...
    const deleted = await db.deleteFrom('pages')
      .where('id', '=', this.id)
      .execute()
  ...
  static async remove(id: number): Promise<any> {
    ...
    return await db.deleteFrom('pages')
      .where('id', '=', id)
      .execute()
  }
...
export async function remove(id: number): Promise<void> {
  await db.deleteFrom('pages')
    .where('id', '=', id)
    .execute()
}

export async function whereTitle(value: string): Promise<PageModel[]> {
          const query = db.selectFrom('pages').where('title', '=', value)
...
export async function whereTemplate(value: string): Promise<PageModel[]> {
          const query = db.selectFrom('pages').where('template', '=', value)
          const results: PageJsonResponse = await query.execute()
...
export async function whereViews(value: number): Promise<PageModel[]> {
          const query = db.selectFrom('pages').where('views', '=', value)
          const results: PageJsonResponse = await query.execute()
...
export async function wherePublishedAt(value: Date | string): Promise<PageModel[]> {
          const query = db.selectFrom('pages').where('published_at', '=', value)
          const results: PageJsonResponse = await query.execute()
...
export async function whereConversions(value: number): Promise<PageModel[]> {
          const query = db.selectFrom('pages').where('conversions', '=', value)
          const results: PageJsonResponse = await query.execute()
