...
export class ActivityModel {
  ...
  whereRef(column: string, operator: string, value: string): ActivityModel {
    return ActivityModel.whereRef(column, operator, value)
  }

  static whereRef(column: string, operator: string, value: string): ActivityModel {
    const instance = new ActivityModel(null)
  ...
  orWhere(...args: Array<[string, string, any]>): ActivityModel {
    return ActivityModel.orWhere(...args)
  }

  static orWhere(...args: Array<[string, string, any]>): ActivityModel {
    const instance = new ActivityModel(null)
