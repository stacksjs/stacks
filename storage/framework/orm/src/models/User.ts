import type { Generated, Insertable, RawBuilder, Selectable, Updateable, Sql} from '@stacksjs/database'
      ...
      import { PaymentMethodsTable } from './PaymentMethod'
import { PaymentTransactionsTable } from './PaymentTransaction'
...
stripe_id: this.stripe_id
      ...
      async function find(id: number): Promise<UserModel | undefined> {
        let query = DB.instance.selectFrom('users').where('id', '=', id).selectAll()
