...
export class ProductVariantModel {
  ...
  mapCustomGetters(models: ProductVariantJsonResponse | ProductVariantJsonResponse[]): void {
    const data = models
  ...
  async applyFind(id: number): Promise<ProductVariantModel | undefined> {
  ...
  async find(id: number): Promise<ProductVariantModel | undefined> {
  ...
  applyWhere<V>(column: keyof ProductVariantsTable, ...args: [V] | [Operator, V]): ProductVariantModel {
    if (args.length === 1) {
      const [value] = args
  ...
  where<V = string>(column: keyof ProductVariantsTable, ...args: [V] | [Operator, V]): ProductVariantModel {
  ...
  whereColumn(first: keyof ProductVariantsTable, operator: Operator, second: keyof ProductVariantsTable): ProductVariantModel {
  ...
  applyWhereRef(column: keyof ProductVariantsTable, ...args: string[]): ProductVariantModel {
  ...
  whereRef(column: keyof ProductVariantsTable, ...args: string[]): ProductVariantModel {
  ...
  whereRaw(sqlStatement: string): ProductVariantModel {
  ...
  applyOrWhere(...conditions: [string, any][]): ProductVariantModel {
  ...
  orWhere(...conditions: [string, any][]): ProductVariantModel {
  ...
  when(
    condition: boolean,
    callback: (query: ProductVariantModel) => ProductVariantModel,
  ): ProductVariantModel {
    return ProductVariantModel.when(condition, callback)
  }
  ...
  static when(
    ...
    let instance = new ProductVariantModel(undefined)
  ...
  whereNotNull(column: keyof ProductVariantsTable): ProductVariantModel {
    this.selectFromQuery = this.selectFromQuery.where((eb: any) =>
  ...
  whereNull(column: keyof ProductVariantsTable): ProductVariantModel {
    this.selectFromQuery = this.selectFromQuery.where((eb: any) =>
  ...
  async loadRelations(models: ProductVariantJsonResponse | ProductVariantJsonResponse[]): Promise<void> {
