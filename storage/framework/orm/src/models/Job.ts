...
export class JobModel {
  ...
  orWhere(...conditions: (string | [string, any] | [string, string, any])[]): JobModel {
    return JobModel.orWhere(...conditions)
  }

  static orWhere(...conditions: (string | [string, any] | [string, string, any])[]): JobModel {
    const instance = new JobModel(null)
