...
export class SubscriberEmailModel {
  ...
  orWhere(...conditions: (string | [string, any] | [string, string, any])[]): SubscriberEmailModel {
    return SubscriberEmailModel.orWhere(...conditions)
  }

  static orWhere(...conditions: (string | [string, any] | [string, string, any])[]): SubscriberEmailModel {
    const instance = new SubscriberEmailModel(null)
