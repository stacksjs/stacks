...
export class PostModel {
  ...
  orWhere(...conditions: (string | [string, any] | [string, string, any])[]): PostModel {
    return PostModel.orWhere(...conditions)
  }

  static orWhere(...conditions: (string | [string, any] | [string, string, any])[]): PostModel {
    const instance = new PostModel(null)
