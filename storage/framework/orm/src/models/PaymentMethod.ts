...
export class PaymentMethodModel {
  ...
  orWhere(...conditions: (string | [string, any] | [string, string, any])[]): PaymentMethodModel {
    return PaymentMethodModel.orWhere(...conditions)
  }

  static orWhere(...conditions: (string | [string, any] | [string, string, any])[]): PaymentMethodModel {
    const instance = new PaymentMethodModel(null)
