...
export class SubscriberModel extends BaseOrm<SubscriberModel, SubscribersTable> {
  ...
  static when(
    ...
    let instance = new SubscriberModel(undefined)
  ...
  whereNotNull(column: keyof SubscribersTable): SubscriberModel {
    this.selectFromQuery = this.selectFromQuery.where((eb: any) =>
  ...
  whereNull(column: keyof SubscribersTable): SubscriberModel {
    this.selectFromQuery = this.selectFromQuery.where((eb: any) =>
  ...
  applyWhereBetween<V>(column: keyof SubscribersTable, range: [V, V]): SubscriberModel {
    if (range.length !== 2) {
  ...
  applyWhereLike(column: keyof SubscribersTable, value: string): SubscriberModel {
  ...
  whereLike(column: keyof SubscribersTable, value: string): SubscriberModel {
  ...
  applyWhereNotIn<V>(column: keyof SubscribersTable, values: V[]): SubscriberModel {
  ...
  whereNotIn<V>(column: keyof SubscribersTable, values: V[]): SubscriberModel {
  ...
  static async latest(): Promise<SubscriberModel | undefined> {
    const instance = new SubscriberModel(undefined)
  ...
  static async oldest(): Promise<SubscriberModel | undefined> {
    const instance = new SubscriberModel(undefined)
