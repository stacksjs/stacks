...
export class SubscriberModel {
  ...
  private static applyWhere(instance: SubscriberModel, column: string, ...args: any[]): SubscriberModel {
  ...
  where(column: string, ...args: any[]): SubscriberModel {
    return SubscriberModel.applyWhere(this, column, ...args)
  }

  static where(column: string, ...args: any[]): SubscriberModel {
    const instance = new SubscriberModel(null)
    return SubscriberModel.applyWhere(instance, column, ...args)
  }
  ...
  orWhere(...conditions: (string | [string, any] | [string, string, any])[]): SubscriberModel {
    return SubscriberModel.orWhere(...conditions)
  }

  static orWhere(...conditions: (string | [string, any] | [string, string, any])[]): SubscriberModel {
    const instance = new SubscriberModel(null)
  ...
  whereLike(column: keyof SubscriberType, value: string): SubscriberModel {
    return SubscriberModel.whereLike(column, value)
  }
