...
export class TaxRateModel extends BaseOrm<TaxRateModel, TaxRatesTable, TaxRateJsonResponse> {
  ...
  constructor(taxRate: TaxRateJsonResponse | undefined) {
    ...
    this.withRelations = []
    this.selectFromQuery = db.selectFrom('tax_rates')
    this.updateFromQuery = db.updateTable('tax_rates')
    this.deleteFromQuery = db.deleteFrom('tax_rates')
...
set updated_at(value: string) {
  ...
  static async find(id: number): Promise<TaxRateModel | undefined> {
    let query = db.selectFrom('tax_rates').where('id', '=', id).selectAll()
  ...
  static async all(): Promise<TaxRateModel[]> {
    ...
    const models = await db.selectFrom('tax_rates').selectAll().execute()
  ...
  async applyCreate(newTaxRate: NewTaxRate): Promise<TaxRateModel> {
    ...
    const result = await db.insertInto('tax_rates')
      .values(filteredValues)
      .executeTakeFirst()

    const model = await db.selectFrom('tax_rates')
 ...
 dispatch('taxRate:created', model)
  ...
  async update(newTaxRate: TaxRateUpdate): Promise<TaxRateModel | undefined> {
    ...
    await db.updateTable('tax_rates')
      .set(filteredValues)
      .where('id', '=', this.id)
      .executeTakeFirst()
 ...
 dispatch('taxRate:deleted', model)
    ...
    const deleted = await db.deleteFrom('tax_rates')
      .where('id', '=', this.id)
      .execute()
 ...
 dispatch('taxRate:deleted', model)
    ...
    return await db.deleteFrom('tax_rates')
      .where('id', '=', id)
      .execute()
  }
...
export async function remove(id: number): Promise<void> {
  await db.deleteFrom('tax_rates')
    .where('id', '=', id)
    .execute()
}

export async function whereName(value: string): Promise<TaxRateModel[]> {
          const query = db.selectFrom('tax_rates').where('name', '=', value)
...
export async function whereRate(value: number): Promise<TaxRateModel[]> {
          const query = db.selectFrom('tax_rates').where('rate', '=', value)
          const results: TaxRateJsonResponse = await query.execute()
...
export async function whereType(value: string): Promise<TaxRateModel[]> {
          const query = db.selectFrom('tax_rates').where('type', '=', value)
          const results: TaxRateJsonResponse = await query.execute()
...
export async function whereCountry(value: string): Promise<TaxRateModel[]> {
          const query = db.selectFrom('tax_rates').where('country', '=', value)
          const results: TaxRateJsonResponse = await query.execute()
...
export async function whereRegion(value: string | string[]): Promise<TaxRateModel[]> {
          const query = db.selectFrom('tax_rates').where('region', '=', value)
          const results: TaxRateJsonResponse = await query.execute()
...
export async function whereStatus(value: string | string[]): Promise<TaxRateModel[]> {
          const query = db.selectFrom('tax_rates').where('status', '=', value)
          const results: TaxRateJsonResponse = await query.execute()
...
export async function whereIsDefault(value: boolean): Promise<TaxRateModel[]> {
          const query = db.selectFrom('tax_rates').where('is_default', '=', value)
          const results: TaxRateJsonResponse = await query.execute()
