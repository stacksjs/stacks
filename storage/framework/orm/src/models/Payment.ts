...
export class PaymentModel {
  ...
  mapCustomGetters(models: PaymentJsonResponse | PaymentJsonResponse[]): void {
    const data = models
  ...
  async applyFind(id: number): Promise<PaymentModel | undefined> {
  ...
  async find(id: number): Promise<PaymentModel | undefined> {
  ...
  static async first(): Promise<PaymentModel | undefined> {
    const instance = new PaymentJsonResponse(null)
  ...
  applyWhere<V>(column: keyof PaymentsTable, ...args: [V] | [Operator, V]): PaymentModel {
    if (args.length === 1) {
      const [value] = args
  ...
  where<V = string>(column: keyof PaymentsTable, ...args: [V] | [Operator, V]): PaymentModel {
  ...
  applyOrWhere(...conditions: [string, any][]): PaymentModel {
  ...
  orWhere(...conditions: [string, any][]): PaymentModel {
  ...
  when(
    condition: boolean,
    callback: (query: PaymentModel) => PaymentModel,
  ): PaymentModel {
    return PaymentModel.when(condition, callback)
  }
  ...
  static when(
    ...
    let instance = new PaymentModel(undefined)
  ...
  whereNotNull(column: keyof PaymentsTable): PaymentModel {
    this.selectFromQuery = this.selectFromQuery.where((eb: any) =>
  ...
  whereNull(column: keyof PaymentsTable): PaymentModel {
    this.selectFromQuery = this.selectFromQuery.where((eb: any) =>
  ...
  applyWhereIn<V>(column: keyof PaymentsTable, values: V[]) {
  ...
  whereIn<V = number>(column: keyof PaymentsTable, values: V[]): PaymentModel {
  ...
  applyWhereBetween<V>(column: keyof PaymentsTable, range: [V, V]): PaymentModel {
    if (range.length !== 2) {
  ...
  whereBetween<V = number>(column: keyof PaymentsTable, range: [V, V]): PaymentModel {
  ...
  applyWhereLike(column: keyof PaymentsTable, value: string): PaymentModel {
  ...
  whereLike(column: keyof PaymentsTable, value: string): PaymentModel {
  ...
  applyWhereNotIn<V>(column: keyof PaymentsTable, values: V[]): PaymentModel {
  ...
  whereNotIn<V>(column: keyof PaymentsTable, values: V[]): PaymentModel {
  ...
  async loadRelations(models: PaymentJsonResponse | PaymentJsonResponse[]): Promise<void> {
  ...
  with(relations: string[]): PaymentModel {
  ...
  static async last(): Promise<PaymentModel | undefined> {
    const model = await DB.instance.selectFrom('payments').selectAll().orderBy('id', 'desc').executeTakeFirst()
  ...
  orderBy(column: keyof PaymentsTable, order: 'asc' | 'desc'): PaymentModel {
  ...
  groupBy(column: keyof PaymentsTable): PaymentModel {
  ...
  having<V = string>(column: keyof PaymentsTable, operator: Operator, value: V): PaymentModel {
  ...
  orderByDesc(column: keyof PaymentsTable): PaymentModel {
  ...
  orderByAsc(column: keyof PaymentsTable): PaymentModel {
