...
export interface AccessTokenRequestType extends Request {
      validate(attributes?: CustomAttributes): void
       get<T>(key: T): string | undefined get(key: 'team_id'): string 
...
export interface SubscriberRequestType extends Request {
      validate(attributes?: CustomAttributes): void
       get<T>(key: T): string | undefined get(key: 'user_id'): string 
...
export interface ProductRequestType extends Request {
      validate(attributes?: CustomAttributes): void
       get<T>(key: T): string | undefined get(key: 'product_category_id'): string 
...
export interface PaymentTransactionRequestType extends Request {
      validate(attributes?: CustomAttributes): void
       get<T>(key: T): string | undefined get(key: 'user_id'): string 
 get(key: 'payment_method_id'): string 
...
export interface OrderRequestType extends Request {
      validate(attributes?: CustomAttributes): void
       get<T>(key: T): string | undefined get(key: 'customer_id'): string 
 get(key: 'gift_card_id'): string 
 get(key: 'coupon_id'): string 
