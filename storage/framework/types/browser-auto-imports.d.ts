...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { Customers, Coupons, GiftCards, Orders, Posts, Payments, TaxRates, Categories, Units, ProductItems, Reviews, Drivers, DeliveryRoutes, DigitalDeliveries, ShippingMethods, ShippingRates, ShippingZones, ProductVariants, Tags, Categorizable, Pages } from '../defaults/functions/types'
