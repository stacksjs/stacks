...
import { italic, log, runCommand } from 'stacks:cli'
import type { Result } from 'stacks:error-handling'
import { err, ok } from 'stacks:error-handling'
import { frameworkPath, projectPath } from 'stacks:path'
import * as storage from 'stacks:storage'
import type { CliOptions, Manifest, StacksError, SyncSubprocess } from 'stacks:types'
import type { NpmScript } from 'stacks:enums'
