    ...
    <div class="px-12">
      <div class="flex flex-col lg:flex-row py-16 max-w-7xl mx-auto">
        ...
        <div class="flex-auto mx-auto lg:flex-1 pr-24">
          ...
          <ul
            role="list"
            class="divide-y divide-gray-200 dark:divide-gray-600 pt-2"
          >
            ...
            <li class="relative flex items-center space-x-4 py-4">
              <div class="min-w-0 flex-auto">
                <div class="flex items-center gap-x-3">
                  <div class="flex-none rounded-full p-1 text-red-500 bg-red-300/10">
        ...
        <!-- Recent Commits -->
        <div class="flex-auto mx-auto lg:flex-1">
          <div>
            <h2 class="mx-auto max-w-2xl text-base font-semibold leading-6 text-gray-900 dark:text-gray-100 lg:mx-0 lg:max-w-none dark:text-gray-100">
              Recent Commits
            </h2>
          ...
          <ul
            role="list"
            class="divide-y divide-white/5 pt-2"
          >
            <li class="py-4">
              <div class="flex items-center gap-x-3">
                <img
              ...
              <p class="mt-3 truncate text-sm text-gray-500">
                Pushed to <span class="text-gray-400">stacks</span> (<span class="font-mono text-gray-400">2d89f0c8</span> on <span class="text-gray-400">main</span>)
              </p>
            </li>
            <li class="py-4">
              <div class="flex items-center gap-x-3">
              ...
              <p class="mt-3 truncate text-sm text-gray-500">
                Pushed to <span class="text-gray-400">stacks</span> (<span class="font-mono text-gray-400">249df660</span> on <span class="text-gray-400">main</span>)
              </p>
            </li>
            <li class="py-4">
              <div class="flex items-center gap-x-3">
              ...
              <p class="mt-3 truncate text-sm text-gray-500">
                Pushed to <span class="text-gray-400">stacks</span> (<span class="font-mono text-gray-400">11464223</span> on <span class="text-gray-400">main</span>)
              </p>
            </li>
          </ul>
        </div>
