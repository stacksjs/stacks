...

  {
    ...
    page: {
      ...
      ourStrengths: [
        ...
        { title: 'Real products, not a demo', text: 'BugHQ (bughq.org), UptimeStatus (statushq.org), and LogHQ (loghq.org) are Stacks applications running in production today, and all three are open source you can self-host rather than a SaaS you rent. CommsHQ, a marketing and communications platform built the same way, goes further either direction: self-host it for free or take one of its own hosted subscription plans.' },
      ],
      rows: [
