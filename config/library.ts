...
export default { ORGANIZATION_NAME, LIBRARY_NAME, VUE_PACKAGE_NAME, VUE_NPM_PACKAGE_NAME, WEB_COMPONENTS_PACKAGE_NAME, WEB_COMPONENTS_NPM_PACKAGE_NAME, COMPOSABLE_PACKAGE_NAME, COMPOSABLE_NPM_PACKAGE_NAME }
