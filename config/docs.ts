  ...
  '/guide/': [
...

    {
      ...
      items: [
        ...
        { text: 'Unit & Feature Tests', link: '/bootcamp/testing' },
        ...
        { text: 'How to “uninstall”?', link: '/bootcamp/uninstall' },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Your Mailbox', link: '/bootcamp/tips/mailbox' },
            { text: 'Error Handling', link: '/bootcamp/tips/error-handling' },
            { text: 'IDE Setup', link: '/bootcamp/tips/ide' },
            ...
            { text: 'Extend the Cloud', link: '/bootcamp/tips/cloud' },
            { text: 'Extend the Dashboard', link: '/bootcamp/tips/dashboard' },
