...
const eventForm = ref({
  ...
  tracking_code_post: null,
})

const dateFields = ref([{ date: null, start_time: null, end_time: null }])

async function saveEvent() {
  eventForm.value.datetimes = dateFields.value

  try {
    errors.value = {}

    await eventStore.createEvent(eventForm.value)
    await toast.success({ text: 'Successfully created event!' })
...
function removeDate(index: number) {
  dateFields.value.splice(index, 1)
}
</script>
                  ...
                  <div class="w-2/3 pl-8">
                    <div class="flex flex-col">
                      ...
                      >
                        ...
                        >
                          <input
                            v-model="eventForm.name_spanish"
                            type="text"
                            class="block mt-1.5 w-full required:border-red-500 px-3 py-2 rounded text-gray-900 border border-gray-300 shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:text-gray-100 focus:border-teal-500 dark:border-gray-500 focus:outline-none focus:ring-2;s"
                          >
                        </div>
                      ...
                      >
                        ...
                        >
                          <input
                            v-model="eventForm.salesforce_id"
                            type="text"
                            class="block mt-1.5 w-full required:border-red-500 px-3 py-2 rounded text-gray-900 border border-gray-300 shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:text-gray-100 focus:border-teal-500 dark:border-gray-500 focus:outline-none focus:ring-2;s"
                          >
                        </div>
                      ...
                      >
                        ...
                        >
                          <input
                            v-model="eventForm.webex_password"
                            type="text"
                            class="block mt-1.5 w-full required:border-red-500 px-3 py-2 rounded text-gray-900 border border-gray-300 shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:text-gray-100 focus:border-teal-500 dark:border-gray-500 focus:outline-none focus:ring-2;s"
                            :required="hasError(errors, 'webex_password')"
                          >
                          ...
                          <span
                            ...
                            class="text-xs text-red-500"
                          >
                            {{ getError(errors, 'webex_password') }}
                          </span>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        >
                          <input
                            v-model="eventForm.attendees_limit"
                            type="number"
                            class="block mt-1.5 w-full required:border-red-500 px-3 py-2 rounded text-gray-900 border border-gray-300 shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:text-gray-100 focus:border-teal-500 dark:border-gray-500 focus:outline-none focus:ring-2;s"
                            :required="hasError(errors, 'attendees_limit')"
                          >
                          ...
                          <span
                            ...
                            class="text-xs text-red-500"
                          >
                            {{ getError(errors, 'attendees_limit') }}
                          </span>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        <div>
                          <input
                            ...
                            type="text"
                            class="block mt-1.5 w-full required:border-red-500 px-3 py-2 rounded text-gray-900 border border-gray-300 shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:text-gray-100 focus:border-teal-500 dark:border-gray-500 focus:outline-none focus:ring-2;s"
                            :required="hasError(errors, 'location')"
                          >
                      ...
                      >
                        ...
                        <div>
                          <input
                            ...
                            type="text"
                            class="block mt-1.5 w-full required:border-red-500 px-3 py-2 rounded text-gray-900 border border-gray-300 shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:text-gray-100 focus:border-teal-500 dark:border-gray-500 focus:outline-none focus:ring-2;s"
                            :required="hasError(errors, 'address')"
                          >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <input
                                id="npn-required"
                                v-model="eventForm.npn_not_required"
                                type="checkbox"
                                class="w-4 h-4 border-gray-300 rounded cursor-pointer text-custom-blue focus:ring-custom-blue"
                              >
                            </div>
