...
const descriptionString = computed(() => {
  return (
    description
    || 'No content matched your criteria. Try searching for something else or add a new data.'
  )
})
</script>
...
<template>
  <div class="flex flex-col items-center justify-center w-full py-5 text-center">
    ...
    <h1 class="mt-2 text-xl text-gray-500 dark:text-gray-400">
      {{ titleString }}
    </h1>
