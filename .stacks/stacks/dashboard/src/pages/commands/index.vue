    ...
    <form class="rounded-lg bg-white px-6 py-4 text-sm dark:bg-blue-gray-800">
      ...
      <div class="py-2">
        ...
        <div class="mt-4 flex flex-col">
          <label class="dark:text-gray-100">Type a Command</label>
            ...
            <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-600">
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-gray-600 bg-white dark:bg-blue-gray-800 dark:bg-blue-gray-800">
                <tr>
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">
                    <pre
                      v-highlightjs
                ...
                <tr>
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm dark:text-gray-400 text-gray-500">
                    3 hours ago
                  </td>
                  <td class="whitespace-nowrap px-3 py-4 text-sm dark:text-gray-400 text-gray-500">
                    30s
