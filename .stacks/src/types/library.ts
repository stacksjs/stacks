...
/**
 * The list of accpeted SPDX licenses.
 * When developing OS packages, you may want to utilize an OSI apporved license.
...
/**
 * The author's name of the library/package/application.
 */
...
export interface LibraryOptions {
  ...
  /**
   * Should your library genearte a sourcemap?
   * @default false
   */
