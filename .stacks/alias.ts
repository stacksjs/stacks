...
const alias: Record<string, string> = {
  ...
  '@stacksjs/actions/generate': p.actionsPath('src/generate/index.ts'),
  ...
  '@stacksjs/cli': p.stacksPath('cli.ts'),
  '@stacksjs/cli/*': p.cliPath('*'),
  ...
  '@stacksjs/fs': p.fsPath('src/index.ts'),
  '@stacksjs/fs/*': p.fsPath('src/*'),
