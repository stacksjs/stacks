...
route.get('/stripe/fetch-transaction-history', 'Actions/Payment/FetchTransactionHistoryAction')
...
route.post('/stripe/cancel-subscription', 'Actions/Payment/CancelSubscriptionAction')
